...
### 3. 모델학습
#### 3-1. [클러스터링](https://github.com/jukyellow/artificial-intelligence-study/tree/master/06_%EB%85%BC%EB%AC%B8_study)  

<br>

### 4. 논문 Study
#### 4-1. [Seq2Seq, Embedding, Attention, TFIDF](https://github.com/jukyellow/artificial-intelligence-study/tree/master/06_%EB%85%BC%EB%AC%B8_study)  

<br>

### 5. Library  
#### 5-1. [Library(Colab,GoogleDrive,Gensim,Pre-Trained)](https://github.com/jukyellow/artificial-intelligence-study/tree/master/05_Colab_GoogleDrive_PreTrained_Gensim_Lib)

<br>

### 6. 자연어 처리(Natural language processing)
#### 6-1. [Data정제](https://github.com/jukyellow/artificial-intelligence-study/blob/master/08_NLP.md)  
