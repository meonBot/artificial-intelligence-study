# -*- coding: utf-8 -*-
"""keras-seq2seq-Addr2Postcode.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1aq_HtvFMwviMgSTBXwjL5AjM4RZDrQxK
"""

#https://github.com/philipperemy/keras-attention-mechanism

#메모리 문제로 사이즈 줄여서 테스트(346,751->10,000)
!git clone https://github.com/jukyellow/keras-seq2seq-example
...
#import numpy as np
#nohup = np.loadtxt('nohup.out', dtype=np.str)
#print(nohup)
...
for iteration in range(1, 50): #default 200;
    print()
    print('-' * 50)
