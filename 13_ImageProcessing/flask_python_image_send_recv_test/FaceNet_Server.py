...
# curl -X POST -F image=@강아지.jpg 'http://localhost:8201/face_predict'
...
def predict():
	...
	if flask.request.method == "POST":
		if flask.request.files.get("image"):
			...
			image_exp_dim, image_arr = prepare_image(image, target=(224, 224))
